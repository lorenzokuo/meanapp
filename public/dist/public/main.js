...
/* harmony import */ var _write_write_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./write/write.component */ "./src/app/write/write.component.ts");
...
var routes = [
    ...
    { path: 'reviews/:id', component: _review_review_component__WEBPACK_IMPORTED_MODULE_4__["ReviewComponent"] },
    { path: 'edit/:id', component: _edit_edit_component__WEBPACK_IMPORTED_MODULE_5__["EditComponent"] },
    { path: 'write/:id', component: _write_write_component__WEBPACK_IMPORTED_MODULE_6__["WriteComponent"] }
];
...
/* harmony import */ var _write_write_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./write/write.component */ "./src/app/write/write.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _write_write_component__WEBPACK_IMPORTED_MODULE_8__["WriteComponent"]
            ],
            imports: [
...
module.exports = "p {\n    color: red;\n    font-size: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<button class=\"waves-effect waves-light btn #ffd54f amber lighten-2\n\" [routerLink]= \"['new']\">New Restaurant</button>\n\n<table>\n  <tr>\n    <th>Restaurant</th>\n    <th>Cuisine</th> \n    <th>Actions available</th>\n  </tr>\n  <tr>\n  <tr *ngFor = \"let rest of rests\">\n    <td>{{rest.name}}</td>\n    <td>{{rest.cuisine}}</td>\n    <td>\n      <button class=\"waves-effect waves-light btn-small\" [routerLink]= \"['reviews', rest._id]\">Read reviews</button>\n      <button class=\"waves-effect waves-light btn-small #80cbc4 teal lighten-3\n      \" [routerLink]= \"['edit', rest._id]\">Update</button>\n      <button class=\"waves-effect waves-light btn-small #e0f2f1 teal lighten-5\n      \" (click)= \"deleteRest(rest._id)\">Delete</button>\n    </td>\n  </tr>\n</table>\n"
...
module.exports = "p {\n    color: red;\n    font-size: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<h4>Register a restaurant</h4>\n<div>\n    <form (submit)=\"check()\">\n      <h6>Restaurant name:</h6>\n      <br>\n      <input type=\"text\" [(ngModel)]=\"rest.name\" name=\"rest.name\">\n      <br>\n      <h6>Cuisine:</h6>\n      <br>\n      <input type=\"text\" [(ngModel)]=\"rest.cuisine\" name=\"rest.cuisine\">\n      <br>\n      <div class=\"row\">\n        <div class=\"col s6\">\n            <button class=\"waves-effect waves-light btn-small #80cbc4 teal lighten-3\" [routerLink]=\"['']\">Cancel</button>\n        </div>\n        <div class=\"col s6\">\n            <input class=\"waves-effect waves-light btn-small\" type=\"submit\" value=\"Register\">\n        </div>\n      </div>\n    </form>\n</div>\n<p *ngFor=\"let messages of array\">{{messages}}</p>"
...
module.exports = "<h4>Reviews for {{rest.name}}</h4>\n<button class=\"waves-effect waves-light btn #ffd54f amber lighten-2\n\" [routerLink]= \"['/write', rest._id]\">New Review</button>\n<table>\n  <tr>\n    <th>Customer</th>\n    <th>Stars &#9733;</th> \n    <th>Description</th>\n  </tr>\n  <tr>\n  <tr *ngFor = \"let review of rest.reviews\">\n    <td>{{review.name}}</td>\n    <td>{{review.stars}}</td>\n    <td>{{review.review}}</td>\n  </tr>\n</table>\n<br>\n<button class=\"waves-effect waves-light btn-small #80cbc4 teal lighten-3\" [routerLink]=\"['']\">Go Back</button>\n"
...
module.exports = "p {\n    color: red;\n    font-size: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "\n<h4>Write a review for {{rest.name}}</h4>\n<div>\n  <form (submit)=\"check()\">\n    <h6>Your name:</h6>\n    <br>\n    <input type=\"text\" [(ngModel)]=\"review.name\" name=\"name\">\n    <br>\n    <h6>Stars:&#9733;</h6>\n    <br>\n    <div input-field>\n      <select class=\"browser-default\" [(ngModel)]=\"review.stars\" name = \"stars\" material-select watch>\n        <option value=\"\"></option>\n        <option value=1>1</option>\n        <option value=2>2</option>\n        <option value=3>3</option>\n        <option value=4>4</option>\n        <option value=5>5</option>\n      </select>\n      <!-- <label for=\"\">select option</label> -->\n    </div>\n    <br>\n    <h6>Your review:</h6>\n    <input type=\"text\" [(ngModel)]=\"review.review\" name=\"review\">\n    <br>\n    <div class=\"row\">\n      <div class=\"col s6\">\n          <button class=\"waves-effect waves-light btn-small #80cbc4 teal lighten-3\" [routerLink]=\"['']\">Cancel</button>\n      </div>\n      <div class=\"col s6\">\n          <input class=\"waves-effect waves-light btn-small\" type=\"submit\" value=\"Submit\">\n      </div>\n    </div>\n  </form>\n</div>\n<p *ngFor=\"let messages of array\">{{messages}}</p>"
...
var WriteComponent = /** @class */ (function () {
    ...
    WriteComponent.prototype.check = function () {
        ...
        observable.subscribe(function (data) {
            if (data['errors']) {
                console.log(data);
                _this.array = [];
                for (var name_1 in data['errors']) {
                    _this.array.push(data['errors'][name_1].message);
                    console.log(_this.array);
                }
            }
            else {
    ...
    WriteComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-write',
            template: __webpack_require__(/*! ./write.component.html */ "./src/app/write/write.component.html"),
            styles: [__webpack_require__(/*! ./write.component.css */ "./src/app/write/write.component.css")]
        }),
        __metadata("design:paramtypes", [_http_service__WEBPACK_IMPORTED_MODULE_1__["HttpService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], WriteComponent);
...
module.exports = __webpack_require__(/*! /Users/erer/Desktop/Coding Dojo/04_MEAN/06_Angular/00_belt_exam_practice/mean_belt/public/src/main.ts */"./src/main.ts");
